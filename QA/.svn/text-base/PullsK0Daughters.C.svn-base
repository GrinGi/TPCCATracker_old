...
//  basiclibs();
  ...
  OutFileName[0]="K0FitDaughters.pdf";
  ...
  for(int iPerf=0; iPerf<NPerf; iPerf++)
  {
    ...
    DirName += "/KFParticlesFinder/Particles/ks/DaughtersQA";
    ...
    for(int i=0; i<NParameters; i++)
    {
      ...
      fRes[i][iPerf]->SetParameter(1,0);
if(i>2) fRes[i][iPerf]->SetParameter(2,0.008);
